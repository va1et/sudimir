...
import '../../bloc/excursion/excursion_bloc.dart';
    ...
    return Scaffold(
        appBar: CupertinoNavigationBar(
          ...
          trailing: IconButton(
            ...
            onPressed: () {
              context.push('/services/books/booking');
            },
                      ...
                      ? ListView.separated(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Dismissible(
                                ...
                                key: Key(state.books[index].toString()),
                                ...
                                onDismissed: (direction) {
                                  context.read<BookBloc>().add(
                                      BookRemove(id: state.books[index].guid));
                                },
                                child: SizedBox(
                                  width:
                                                    ...
                                                    Padding(
                                                        padding:
                                                            const EdgeInsets
                                                                .only(top: 10),
                                                        child: Text(
                                                          "кол-во людей: ${state.books[index].persons}",
                                                          style: DarkTextTheme
                                                              .subheadlineNS
                                                              .copyWith(
                                                                  color: Theme.of(
